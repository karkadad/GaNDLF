...
def load_data(train_data_csv, valid_data_csv, parameters, train_mode=True):
    ...
    training_data_for_torch = ImagesFromDataFrame(train_data_full, parameters, train=True)
    validation_data_for_torch = ImagesFromDataFrame(valid_data_full, parameters, train=False)
    ...
    parameters["output_dir"] = '/home/rpanchum/upenn/GaNDLF/nncf_scripts/nncf_accaware_outdir'
    print(parameters)
